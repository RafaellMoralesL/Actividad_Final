...
if(edad_conyuge) {
  if (edad_conyuge >= 18 && edad <= 24) {
    ...
    elseif (edad_conyuge >= 25 && edad <=49); {
      recargo_conyuge = preciobase * edad5
    }
    elseif(edad_conyuge >=50); {
      recargo_conyuge = preciobase * edad6
    }
}
 recargo_hjo = preciobase * (cantidad_hijos * recargo_hijos)
 recargo_prop = preciobase * (cantidad_propiedades * recargo_propiedades)
 recargo_ing = recargo_ingresos * ingresos
 
 recargo_total = recargo_hjo + recargo_prop + recargo_ing + recargo + recargo_conyuge;
